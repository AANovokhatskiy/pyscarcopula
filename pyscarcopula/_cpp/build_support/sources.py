...
SCAR_COMPUTE_SOURCES = (
    ...
    "copula/model_policy.cpp",
    "copula/model_statistics.cpp",
    "copula/numerical_validation.cpp",
    "copula/common.cpp",
    "copula/rotation.cpp",
    ...
    *PAIR_FAMILY_SOURCES,
    ...
    "scar_ou/initialization.cpp",
    "scar_ou/parameterization.cpp",
    "scar_ou/policy.cpp",
    "scar_ou/sampling.cpp",
    ...
    "scar_jacobi/sampling.cpp",
)

PYTHON_BINDING_SOURCES = (
    "bindings/common.cpp",
    "bindings/array.cpp",
    "bindings/validation.cpp",
    "bindings/statistics.cpp",
