...
class N21Copula(ArchimedianCopula):
    def __init__(self, dim: int) -> None:
        super().__init__(dim)
        self.__sp_generator = 1 - (1 - (1 - self.t)**self.r )**(1 / self.r)
        self.__sp_inverse_generator = 1 - (1 - (1 - self.t)**self.r )**(1 / self.r)
        self.__name = 'N21 copula'
